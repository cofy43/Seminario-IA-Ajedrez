...
def set_color(color):
    ...
    tablero.set_color(switcher[color])
...
opciones = tk.OptionMenu(ventana, tipografias, "Ninguno", "Verde", "Amarrillo", "Rojo", "Azul", command=set_color)
opciones.config(font=('Helvetica', 12))	
opciones.pack()	
opciones.place(x=455, y=60)
