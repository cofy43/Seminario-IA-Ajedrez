...
def castle(move, board_view, piece_view):
    """
    Funcion principal encargada de realizar 
    el movimiento de enroque.
    ----------
    move : string
        Inicial de la pieza jugada.
    board_view : string
        Representacion en cadena del teblero.
    piece_view : object
        Diccionario donde las llaves son las coordenadas
        del tablero y los valores son las inciales de las 
        piezas o un espacio vacio.
    Returns
    -------
    board_view : string
        Representacion en cadena del teblero despues del enroque.
    piece_view : object
        Diccionario donde las llaves son las coordenadas
        del tablero y los valores son las inciales de las 
        piezas o un espacio vacio despues del enroque.
    """
    if move in "OOO":
...
def not_blocked(from_sq, to_sq, board_view):
    """
    Funcion auxiliar encargada de de verificar que la
    casilla a donde se dirige alguna pieza no este bloqueada.
    Parameters.
    ----------
    from_sq : string
        coordenada donde se encuentra la pieza.
    to_sq: string
        coordenada a donde se dirige la pieza.
    board_view : string
        Representacion en cadena del teblero.
    Returns
    -------
    boolean
        Verdadero si la casilla esta ocupada o Falso en 
        otro caso.
    """
...
def get_from_sq(move, board_view, piece_view):
    """
    Funcion auxiliar encargada de obtener la casilla
    donde se encuentra una pieza.
    Parameters
    ----------
    move : string
        Inicial de la pieza a mover
    board_view : string
        Representacion en cadena del teblero.
    piece_view : object
        Diccionario donde las llaves son las coordenadas
    ...
    -------
    string
        coordenada de donde se encuentra la pieza a mover.
    """
    piece = move[0]
...
def remove_ambiguity(move, possibilities): 
    """
    Funcion auxiliar encargada de eliminar la ambieguedad
    dado algun movimineto de pieza.
    Parameters
    ----------
    move : string
        Inicial de la pieza a mover
    possibilities: objec
        Lista de coordenadas a donde poidria dirigirse 
        la pieza.
    Returns
    -------
    string
        Coordenada a donde se dirigira la pieza.
    """
    location = ''
...
def check_move(piece, location, destination):
    """
    Funcion auxiliar encargada de verificar que un 
    ...
    -------
    boolean
        Verdadero si el movimiento es valido, Falso en 
        otro caso.
    """
...
def move_piece(move, board_view, piece_view):
    """
    Funcion principal encarfada de realizar el 
    movimiento de cualquier pieza que no sea un peon.
    Parameters
    ----------
    move : string
        Inicial de la pieza a mover
